...
//api
    ...
    {
        $cat = Category::where('status','=',1)->orderBy('id','desc')->with('subs','subs.childs')->get();
        // $subcat = Subcategory::where('status','=',1)->orderBy('id','desc')->get();
        // $childcat = Childcategory::where('status','=',1)->orderBy('id','desc')->get();         
        // return [$cat,$subcat,$childcat];
        return $cat;
    }
    public function categoryapi(Request $request, $slug)
    {
        $this->code_image();
        $sort = "";
        $cat = Category::where('slug','=',$slug)->first();
        ...
        return [$cat,$sort,$cats];
    }
    public function subcategoryapi(Request $request,$slug1,$slug2)
    {
        $this->code_image();
        $sort = "";
        ...
        return [$subcat,$sort,$cats];
    }
     public function childcategoryapi(Request $request,$slug1,$slug2,$slug3)
    {
        $this->code_image();
        $sort = "";
