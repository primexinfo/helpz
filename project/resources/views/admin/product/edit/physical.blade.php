								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
					                      ...
					                      <form id="" action="{{route('admin-prod-update',$data->id)}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
				...
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
						                    ...
						                    <div class="{{ !empty($data->whole_sell_qty) ? "":"showbox" }}">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('Add reward point') }}</h4>
																<p class="sub-heading">{{ __('(Optional)') }}</p>
														</div>
													</div>
													<div class="col-lg-7">
														<input name="reward_point" step="0.1" type="number" class="input-field" placeholder="{{ __('e.g 20') }}" value="{{round($data->reward_point)}}" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="vendor_name"  type="text" class="input-field" placeholder="{{ __('Enter Vendor Name') }}" value="{{$data->vendor_name}}">
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
													...
													<div class="col-lg-7">
														<input name="mf_date"  type="date" class="input-field" value="{{$data->mf_date}}">
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
													...
													<div class="col-lg-7">
														<input name="exp_date" type="date" class="input-field" value="{{$data->exp_date}}">
													</div>
												</div>
												...
												<div class="col-lg-7">
													<table class="table table-bordered table-hover">
														...
														@if($data->supplier_product)
															@foreach($data->supplier_product as $key=>$value)
															@php
																$supplier = \App\Models\Supplier::findOrFail($value->supplier_id);
															@endphp
																@if($supplier)
																	<tr>
																		<td>{{$supplier->name}}</td>
																		<td><a href="{{route('product-supplier-delete',['id1' => $value->id, 'id2' => $data->id])}}" class="btn btn-sm btn-danger">Delete</a></td>
																	</tr>
																@endif
															@endforeach
														@endif
